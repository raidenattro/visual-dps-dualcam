...
cp "${ROOT}/scripts/monitor-pose-lag.sh" "${OUT}/scripts/monitor-pose-lag.sh"
...
chmod +x "${OUT}/install.sh" "${OUT}/verify-package.sh" "${OUT}/scripts/load-split-images.sh" "${OUT}/scripts/retag-infer-images.sh" "${OUT}/scripts/monitor-pose-lag.sh"
